  ...
  <div align="center" style="padding: 70px;">
    ...
    <table>
        ...
        <tr style="background-color: black;" align="center">
            ...
            <td style="padding: 10px; color: white; border: 1px solid;">{{$appoint->doctor}}</td>
            <td style="padding: 10px; color: white; border: 1px solid;">{{$appoint->date}}</td>
            <td style="padding: 10px; color: white; border: 1px solid;">{{$appoint->message}}</td>
            <td style="padding: 10px; color: white; border: 1px solid;">{{$appoint->status}}</td>
            <td style="padding: 10px; border: 1px solid;"><a class="btn btn-danger" onclick="return confirm('Are You Sure to Delete This Appointment!')" href="{{url('cancel_appoint', $appoint->id)}}">Cancel</a></td>
